 ...
 */
public class Engineer extends ModelEmploye implements Scoretable{
    private static final float MIN_SCORE = 80.0f;
    
    public Engineer(String nama, int nilai_target, int nilai_disiplin, int nilai_inovasi) {
        setNama(nama);
